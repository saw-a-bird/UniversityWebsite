...
<body>
    ...
    <div class="cd">
        <div class="cadre" >
        <h1 class = "table_name"> Plan etude #<?= $planEtudeID ?>: </h1>
            <div class = "cadre_header">
                ...
                <div class = "_tool_buttons">
                    <a href = "ajouter_unite.php?plan_id=<?= $planEtudeID ?>"><button class = "_btn _green_btn"> Ajouter un unite </button></a>
                    <a href = "ajouter_matiere.php?plan_id=<?= $planEtudeID ?>"><button class = "_btn _green_btn"> Ajouter un matiere </button></a>
                </div>
            </div>
            ...
            <?php
                    for ($sem = 1; $sem <= 2; $sem++) { 
                        ...
                        $unites = $uniteDB->getAllBySemestre($planEtudeID, $sem);
                        $semestreCount = 1;
