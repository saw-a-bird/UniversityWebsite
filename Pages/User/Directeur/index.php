        ...
        <div class="carousel-slider" id="responsive">
            <div class="carousel-content" data-pagination="true">
                <aside class="slide-item">
                    ...
                    <div>
                        <img src="/Assets/imgs/adm_inscription.png" />
                        <a href = "/Pages/Gestion/Parcours/index.php"> <h4> Gestion de parcours </h4> </a>
                    </div>
                ...
                <aside class="slide-item">
                    <div>
                        ...
                        <a href = "/Pages/Gestion/Etudiants.php"> <h4> Gestion etudiants </h4> </a>
                    </div>

                    <div>
                        <img src="/Assets/imgs/ens_crowd.png" />
                        <a href = "/Pages/Gestion/Enseignants.php"> <h4> Gestion enseignants </h4> </a>
                    </div>

                    <div>
                        <img src="/Assets/imgs/ens_crowd.png" />
                        <a href = "/Pages/Gestion/Admins.php"> <h4> Gestion d'administrateurs </h4> </a>
                    </div>
            ...
            <!-- <div>
                ...
                <a href = "/Pages/Gestion/Emplois.php"> <h4> Gestion emplois </h4> </a>
            </div>

            <div>
                <img src="/Assets/imgs/users_icon.png" />
                <a href = "/Pages/Gestion/Classes.php"> <h4> Gestion classes </h4> </a>
            </div>

            <div>
                <img src="/Assets/imgs/users_icon.png" />
                <a href = "/Pages/Gestion/Demandes.php"> <h4> Gestion demandes </h4> </a>
            </div> -->
        </div>
    </div>
